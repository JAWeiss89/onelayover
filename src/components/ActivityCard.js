    ...
    return (
        <div className={`ActivityCard activity-type-${activity.type_id}`} >
            <div className="ActivityCard-image">
                ...
                :
                <img alt={activity.title} style={{width: '150px' }} src="https://images.unsplash.com/photo-1452421822248-d4c2b47f0c81?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=967&q=80" />
                }
                </Link>
            </div>
